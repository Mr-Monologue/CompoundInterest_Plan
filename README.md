# CompoundInterestPlan — Agent 价值定投工作台

帮助投资新手坚持价值定投、平衡牛熊、控制情绪、定期复盘，逐步提高判断力的智能投资工作台。

## 核心特性

- 📋 **Weekly Investment Plan**：每周生成可审计投资计划，用户人工确认后执行
- 🧠 **Value-DCA 框架**：核心—卫星架构，固定定投 + 动态 DCA 双模式
- 🛡️ **风控三层**：资产 MA200 + 主题暴露闸门 + 用户确认闸门
- 📊 **系统记录**：真实执行记录 + 自动生成决策日志
- 🔄 **复盘学习**：每周期复盘决策质量，逐步优化投资规则

> **🛑 no_auto_trade**：系统生成建议和计划，所有交易由用户人工确认执行。

## 旧版 Legacy

<details>
<summary>Legacy / Experimental: Z-Score 网格策略 (v0.x)</summary>
