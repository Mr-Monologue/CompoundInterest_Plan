...
DAILY_TIME = os.getenv("HERMES_WATCHER_DAILY_TIME", "20:30")
ANOMALY_TIME = os.getenv("HERMES_WATCHER_ANOMALY_TIME", "20:40")
WEEKLY_DAY = os.getenv("HERMES_WATCHER_WEEKLY_DAY", "THU").upper()
WEEKLY_TIME = os.getenv("HERMES_WATCHER_WEEKLY_TIME", "21:00")
